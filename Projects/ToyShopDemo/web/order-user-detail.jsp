                ...
                <div class="row">
                    <div class="col-lg-5" style="margin: 0 auto; box-shadow: 0 1px 2px 0 rgba(0,0,0,.30)">
                        <div class="p-5">
                            ...
                            <form class="user" action="update" method="post">
                                ...
                                <c:forEach var="orderItem" items="${orderItems}">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-user" id="${orderItem}" value="${orderItem.product.name}, SL: ${orderItem.quantity}" readonly>
                                    </div>
                                </c:forEach>
                                <div class="form-group">
                                    <label for="total">Total</label> 
                                    <input type="text" class="form-control form-control-user" id="total" value="<fmt:formatNumber value="${order.total}" type="currency"/>" readonly>
                                </div>
                                <div class="form-group">
                            ...
                            <hr>
                            <hr>
                            <a href="home" class="btn btn-primary btn-user btn-block">Back</a>
                        </div>
                    </div>
                </div>
            </div>
